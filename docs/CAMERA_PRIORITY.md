...
> This documentation explains the technical details of the camera priority system.  
> **As a normal user, you don't need to read this** - the program works automatically!
